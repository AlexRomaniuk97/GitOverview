...
//
    public List<Users> users() {
        ...
        usersList.add(new Users("Andrew Orshak", "orshachOK@gmail.com", 380508211866L,
                new GregorianCalendar(1999, Calendar.SEPTEMBER, 17)));
        usersList.add(new Users("Vova Tsyhaniuk", "tsyhaniukvova1997@gmail.com", 380508023102L,
                new GregorianCalendar(1996, Calendar.NOVEMBER, 27)));
        usersList.add(new Users("Vitaliy Romanchuk", "vitalukvitalka@gmail.com", 380994989896L,
                new GregorianCalendar(2002, Calendar.APRIL, 29)));
        usersList.add(new Users("Oksana Litovska", "oksooksi1997@gmail.com", 380973326786L,
                new GregorianCalendar(1994, Calendar.AUGUST, 14)));
        usersList.add(new Users("Andrew Hladchuk", "hladchyk1987@gmail.com", 380905833756L,
                new GregorianCalendar(1997, Calendar.DECEMBER, 1)));
        usersList.add(new Users("Alex Romaniuk", "alexromaniuk1997@gmail.com", 380508211866L,
                new GregorianCalendar(1999, Calendar.JUNE, 13)));
        usersList.add(new Users("Dima Tymchuk", "dmitriyt@gmail.com", 380502384906L,
                new GregorianCalendar(2002, Calendar.JANUARY, 2)));
        usersList.add(new Users("Anna Ivanova", "ivanovaivanova@gmail.com", 380994998987L,
                new GregorianCalendar(2001, Calendar.MAY, 23)));
        usersList.add(new Users("Vasyl Syniyk", "vsyniyk@hmail.com", 380996756564L,
                new GregorianCalendar(1993, Calendar.JUNE, 18)));
        usersList.add(new Users("Nastia Korchinska", "korchinskanastia@gmail.com", 380995878674L,
                new GregorianCalendar(1996, Calendar.JUNE, 8)));
        usersList.add(new Users("Masha Narodova", "narodovamasha@gmail.com", 380971234567L,
                new GregorianCalendar(1997, Calendar.MAY, 1)));
        usersList.add(new Users("Andrew Mazur", "mazurandrew@gmail.com", 380971234523L,
                new GregorianCalendar(1996, Calendar.JULY, 17)));
        usersList.add(new Users("Alex Garabajiy", "garanajiy2000@gmail.com", 380992134523L,
                new GregorianCalendar(2000, Calendar.JUNE, 19)));
        usersList.add(new Users("Ilona Mardar", "IlonaIlona2001@gmail.com", 380992134523L,
